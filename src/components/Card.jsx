import { Link } from "react-router-dom"
 ...
 const Card = ({image ,icon ,title ,artist ,id ,type }) => {
  return (
    <Link to={`/${type}/${id}`} className="w-[180px] hover:shadow-sm hover:shadow-purple-500  m-2 p-1 flex flex-col justify-center items-center pt-4 h-full bg-[#1F1F1F] ">

...
const Sidebar = () => {
  ...
  return (
    <>
      {show ? (
        <div className=" transition-all ease-in duration-200  p-[20px] h-full bg-transparent">
        ...
        <div className="  flex justify-center items-center  m-5 w-10 h-10">
          <button onClick={() => setshow(!show)} className=" text-white w-full h-full flex justify-center items-center">
